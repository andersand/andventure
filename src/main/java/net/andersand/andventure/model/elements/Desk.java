...
/**
 * Bar desk, shop desk, office desk, etc.
 * 
 * @author asn
 */
public class Desk extends Structure implements ContiguousElement {
    ...
    public void align(Element left, Element right, Element up, Element down) {
        String partialFileName = "desk_" + Util.directionString(
    ...
    public List<Class<? extends Element>> getAlignmentClasses() {
        ...
        alignmentClasses.add(Desk.class);
